    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(to='documents.Document', unique=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('native_file', documents.fields.RevisionFileField(storage=django.core.files.storage.FileSystemStorage(base_url=b'/private/', location=b'/home/thibault/code/phase/private'), upload_to=documents.fileutils.revision_file_path, null=True, verbose_name='Native File', blank=True)),
                ('pdf_file', documents.fields.RevisionFileField(storage=django.core.files.storage.FileSystemStorage(base_url=b'/private/', location=b'/home/thibault/code/phase/private'), upload_to=documents.fileutils.revision_file_path, null=True, verbose_name='PDF File', blank=True)),
                ('approver', models.ForeignKey(related_name='default_documents_contractordeliverablerevision_related_approver', verbose_name='Approver', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('document', models.ForeignKey(to='documents.Document')),
                ('leader', models.ForeignKey(related_name='default_documents_contractordeliverablerevision_related_leader', verbose_name='Leader', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('reviewers', models.ManyToManyField(to=settings.AUTH_USER_MODEL, null=True, verbose_name='Reviewers', blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(to='documents.Document')),
                ('leader', models.ForeignKey(related_name='leading_correspondance', verbose_name='Leader', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'ordering': ('-revision',),
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approver', models.ForeignKey(related_name='default_documents_demometadatarevision_related_approver', verbose_name='Approver', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('document', models.ForeignKey(to='documents.Document')),
                ('leader', models.ForeignKey(related_name='default_documents_demometadatarevision_related_leader', verbose_name='Leader', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('reviewers', models.ManyToManyField(to=settings.AUTH_USER_MODEL, null=True, verbose_name='Reviewers', blank=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sequential_number', models.CharField(default='0001', help_text='Type in a four digit number', max_length=4, verbose_name='sequential Number', validators=[default_documents.validators.StringNumberValidator(length=4)])),
                ('document', models.ForeignKey(to='documents.Document', unique=True)),
                ('frm', models.ForeignKey(related_name='sent_transmittals', verbose_name='From', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
            ],
            options={
                'ordering': ('document_key',),
                'verbose_name': 'Transmittals document',
                'verbose_name_plural': 'Transmittals documents',
            },
            bases=(models.Model,),
        ),
        migrations.CreateModel(
            name='TransmittalsRevision',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('revision', models.PositiveIntegerField(default=0, verbose_name='Revision')),
                ('revision_date', models.DateField(default=django.utils.timezone.now, verbose_name='Revision Date')),
                ('created_on', models.DateField(default=django.utils.timezone.now, verbose_name='Created on')),
                ('updated_on', models.DateTimeField(auto_now=True, verbose_name='Updated on')),
                ('status', metadata.fields.ConfigurableChoiceField(max_length=20, verbose_name='Status', list_index=b'STATUS_TRANSMITTALS')),
                ('native_file', documents.fields.RevisionFileField(storage=django.core.files.storage.FileSystemStorage(base_url=b'/private/', location=b'/home/thibault/code/phase/private'), upload_to=documents.fileutils.revision_file_path, null=True, verbose_name='Native File', blank=True)),
                ('pdf_file', documents.fields.RevisionFileField(storage=django.core.files.storage.FileSystemStorage(base_url=b'/private/', location=b'/home/thibault/code/phase/private'), upload_to=documents.fileutils.revision_file_path, null=True, verbose_name='PDF File', blank=True)),
                ('document', models.ForeignKey(to='documents.Document')),
            ],
        ...
        migrations.AddField(
            model_name='transmittals',
            name='latest_revision',
            field=models.ForeignKey(verbose_name='Latest revision', to='default_documents.TransmittalsRevision'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='transmittals',
            name='related_documents',
            field=models.ManyToManyField(related_name='transmittals_related_set', null=True, to='documents.Document', blank=True),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='transmittals',
            name='to',
            field=models.ForeignKey(related_name='received_transmittals', verbose_name='To', blank=True, to=settings.AUTH_USER_MODEL, null=True),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='transmittals',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='mom_correspondence_related_set', null=True, to='default_documents.Correspondence', blank=True),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='minutesofmeeting',
        ...
        migrations.AddField(
            model_name='demometadata',
            name='related_documents',
            field=models.ManyToManyField(related_name='demometadata_related_set', null=True, to='documents.Document', blank=True),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='correspondencerevision',
        ...
        migrations.AddField(
            model_name='correspondence',
            name='related_documents',
            field=models.ManyToManyField(related_name='correspondence_related_set', null=True, to='documents.Document', blank=True),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='correspondence',
        ...
        migrations.AddField(
            model_name='contractordeliverable',
            name='related_documents',
            field=models.ManyToManyField(related_name='cd_related_documents', null=True, to='documents.Document', blank=True),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='contractordeliverable',
